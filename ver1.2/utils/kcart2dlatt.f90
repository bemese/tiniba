...
!!! The file must be copied to fort.9
!!! Nk and option should be read from the input line
!!!
  IMPLICIT NONE
  integer :: istat,cual,Nk,i
...
!!! cycle to read the input data with (kx,ky,kz)
  read(*,*)Nk,cual
  do i=1,Nk
!!! read data and put it into a diagonal matrix
     read(9,*)mK(1,1),mK(2,2),mK(3,3)
