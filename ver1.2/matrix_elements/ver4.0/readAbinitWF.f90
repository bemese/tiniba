...
! header format 5.7
! It is read for abinit versions >= 5.7
  SUBROUTINE readwfv57
    ...
    DO itype=1,npsp
       READ(unit=1) title,znuclpsp,zionpsp,pspso,pspdat,pspcod,pspxc,lmn_size
    END DO

    READ(unit=1)residm,((xred(ii,ij),ii=1,3),ij=1,natom),etotal,fermie
    
  END SUBROUTINE readwfv57
