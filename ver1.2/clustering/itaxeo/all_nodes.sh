...
## executables
    allexec=$HOME/tiniba/$version/clustering/itaxeo
    mme_exec_xeon=$HOME/tiniba/$version/matrix_elements/rpmns_new_xeon
    mme_exec_itanium=$HOME/tiniba/$version/matrix_elements/rpmns_new_itanium
## new grid
...
#    ab_exec_hexa=/home/prog/HEXA/abinit-6.8.2/bin/abinit
    ab_exec_hexa=/home/prog/apps/abinit-6.12.3-intel/64/bin/abinit
