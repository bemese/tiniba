...
rm -f finished*
#
where=$HOME/tiniba/$version/clustering/itaxeo
cual=all_nodes.sh
host=$HOSTNAME
...
then
    ...
    Line
    $HOME/tiniba/$version/utils/infiniband-quad.sh .machines_scf.quad
...
then
    ...
    Line
    $HOME/tiniba/$version/utils/infiniband-hexa.sh .machines_scf.hexa
...
$HOME/tiniba/$version/utils/createRemoteDir.sh
}
...
#
    ...
    $HOME/tiniba/$version/utils/check_coord.sh
