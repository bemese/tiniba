...
if [ $nodo = 'node' ]
then
    rpmns_exec=$HOME/tiniba/ver1.0/matrix_elements/rpmns.xeon
fi
if [ $nodo = 'itanium' ]
then
    rpmns_exec=$HOME/tiniba/ver1.0/matrix_elements/rpmns.itanium
fi
if [ $nodo = 'quad' ]
then
    rpmns_exec=$HOME/tiniba/ver1.0/matrix_elements/rpmns.quad
fi
##
if [ ! -d $input ]
then
