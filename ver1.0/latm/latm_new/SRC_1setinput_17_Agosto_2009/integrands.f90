                   ...
                   DO iy=1,3
                      DO iz=1,3
                         ...
                         tmp1= PT3(ix,iy,iz) &
                              ...
                              *aimag(  spiMatElem(ix,icp,ic)*calposMatElem(iy,iv,icp)*posMatElem(iz,ic,iv) &
...
!!! hi simpre prueba esta zeta con el GaAs.
!!! con coherences 
!!! 12 Agosto 2009  respalod 
  SUBROUTINE zeta_bulk_BUENA_RESPALDO_11_AGOSTO_2009
    IMPLICIT NONE
    REAL(DP) :: tmp,tmp1
    REAL(DP) :: PT3(3,3,3)
    ...
    END DO !!
104 FORMAT(E15.7)
  END SUBROUTINE zeta_bulk_BUENA_RESPALDO_11_AGOSTO_2009
!!! <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
!!! <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
!!! <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
