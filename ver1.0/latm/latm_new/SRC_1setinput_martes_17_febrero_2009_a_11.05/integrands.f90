...
!!!--------------------------------
  ...
  !    ! 17 : zeta_spin_bulk ! 18 : zeta_spin_layered  ! 19 : xi2          ! 20 : eta3
...
!!!BW!
          ...
          CASE(27)
             CALL ndotvv
!!!!!!!!!!! right now we add new response to 17 Febrero 2009 !!!!!
          CASE(28)
             CALL zeta_fred
          CASE DEFAULT
...
!!! <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
!!! <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
!!! <><> this zeta is better and is according to Eq.13 of Nastos et
!!!  al  PRB 76, 205113 (2007) written in terms of Im as in the
!!!   Cabellos et al notes OJOJOJOJO  
!!! <><> 16.feb.2009 <><><><><><><><><><><><><><><><><><> 
!!! <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
!!! hi simpre prueba esta zeta con el GaAs.
                ...
                DO ix=1,3
                   DO iy=1,3
                      DO iz=1,3
                         ...
                         tmp1= PT3(ix,iy,iz) &
                              * aimag( spiMatElem(ix,ic,icp) &
                              *   posMatElem(iy,icp,iv)*posMatElem(iz,iv,ic) &
                              +   spiMatElem(ix,icp,ic) &
                              *   posMatElem(iy,ic,iv)*posMatElem(iz,iv,icp) )
                         tmp = tmp + tmp1
                      END DO
                   END DO
                END DO
