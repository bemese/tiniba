...
!!!        write(69,*)ic,includeTransition(ind_Trans(iv,ic))
!!!           END IF
!!!        END IF
     END DO
  END DO
...
! output
  ...
  DO ienergy=1, energy_Steps
     ...
     !!suma  modify in free format 
     !!WRITE(77,*) energy, (SUM(pp(ienergy,1:nMax*nMax))*units_factor)
  !!!WRITE(*,99) energy, SUM(pp(ienergy,1:nMax*nMax))*units_factor
99   FORMAT(2E15.7)
  END DO
  CLOSE(77)
