...
!!! determine which transition to include in the calculation
  ...
  ! includeValenceBands(5)=1
  ! includeValenceBands(6)=1
   includeValenceBands(7)=1
   includeValenceBands(8)=1
  
  !! conductions 
  includeConductionBands(9)=1    
  includeConductionBands(10)=1
  !includeConductionBands(11)=1    
  !includeConductionBands(12)=1
  !includeConductionBands(13)=1    
  !includeConductionBands(14)=1
