...
!!!
  ...
  write(6,*)'tetra_method.f90: deltaFunctionFactor= ',deltaFunctionFactor
!!!
...
!!! don't change the order of above calls  
  ...
  WRITE(6,*) 'tetra_method.f90: Total transitions@LATM= ', nTrans
  WRITE(*,*) 'tetra_method.f90: tetrahedron MAIN started'
  WRITE(6,*) 'tetra_method.f90: prefactor@LATM: ', units_factor
...
99   FORMAT(2E15.7)
  END DO
  CLOSE(77)
  WRITE(6,*) 'finish writing: ', spectrum_filename
!***************
END PROGRAM LATM
!***************
...
!!!  ELSE
  ...
  write(6,*)'tetra_method.f90: deltaFunctionFactor@Load_Integrand ',deltaFunctionFactor
